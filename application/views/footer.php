<!-- footer top start -->
							...
							<div class="row">
								<div class="col-md-3">
									<div class="footer-content">
										<div class="logo-footer"><img id="logo-footer" src="<?=base_url('assets/images/logo_light_blue.png')?>" alt=""></div>
		...
		<script type="text/javascript" src="<?=base_url('assets/plugins/rs-plugin-5/js/jquery.themepunch.revolution.min.js?rev=5.0')?>"></script>
		<!-- Isotope javascript -->
